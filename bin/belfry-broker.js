...
class Session {
  ...
  async recvLoop() {
    while (!this.shuttingDown) {
      ...
      // Inject it with a minimal placeholder — the harness may silently drop
      // an empty-text channel notification (#37 taught us how quiet that
      // failure is), and this guard used to discard the item entirely, which
      // is where inbound photos died last (2026-07-10).
